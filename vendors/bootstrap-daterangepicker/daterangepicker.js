        ...
        renderCalendar: function(side) {
            ...
            for (var row = 0; row < 6; row++) {
                ...
                for (var col = 0; col < 7; col++) {
                    ...
                    var classes = [];
                     var date = Date().date.toLocaleDateString("fa-IR");
                    //highlight today's date
                    if (calendar[row][col].isSame(date , "day"))
                        classes.push('today');
                    ...
                    html += '<td class="' + cname.replace(/^\s+|\s+$/g, '') + '" data-title="' + 'r' + row + 'c' + col + '">' + calendar[row][col].date().toLocaleDateString("fa-IR") + '</td>';
